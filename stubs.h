...
void apply_ucode_execute_machine_code_simple(UINT8* ucode, UINT64* interrupt_value, MachineCodeMetaData* meta_data);
void apply_ucode_execute_machine_code_restore(UINT8* ucode, UINT64* interrupt_value, MachineCodeMetaData* meta_data);
